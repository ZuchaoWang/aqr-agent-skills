...
- `aqr-doc-criteria` — Content criteria for common documentation types (design, interface, project, research, dataset). Auto-invocable; applied when writing or reviewing docs.
