...
2. **Source and provenance** — where the data came from, how it was obtained, license or terms of use.
...
- Target ~1 page.
- Provenance and license are not optional when they affect whether the data may be used — state them.
