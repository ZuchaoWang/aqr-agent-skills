...
Defines **what good content looks like** for common documentation types and source code. When writing or reviewing doc or code, load the corresponding references and follow the criteria they define.
