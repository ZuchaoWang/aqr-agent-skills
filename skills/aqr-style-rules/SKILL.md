...
| - | - | - |
| Code and tests (Python) | `TypedDict` over `dataclass`, `os.path` over `pathlib`, relative imports, plain test functions, exact-equality assertions, ruff / pyright / pytest toolchain | `reference/code-python.md` |
...
| Documentation (markdown) | summary paragraph, numbered headings, no separators, key: value lists | `reference/documentation.md` |
