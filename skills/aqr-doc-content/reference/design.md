...
- Extract a component when the same UI is needed a second time (to avoid copy-paste); also split when a stateful concern leaks into a presentational component.
